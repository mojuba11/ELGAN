...
const FleetDashboard = () => {
    ...
    const handleLogout = () => {
        if (window.confirm("Confirm logout from Fleet Operations?")) {
            ...
            // Navigate to login
            navigate('/login');
            // Force a reload to wipe the App.js 'user' state instantly
    ...
    useEffect(() => {
        fetchMyEntries();
        // Load the actual user name from login
                    ...
                    <div className="overflow-x-auto">
                        <table className="w-full text-left border-collapse">
                            ...
                            <tbody className="divide-y divide-slate-100">
                                {loading ? (
                                    <tr><td colSpan="5" className="p-20 text-center text-slate-400 animate-pulse font-bold uppercase text-xs">Syncing Fleet Database...</td></tr>
                                    ...
                                    <tr key={entry._id} className="hover:bg-blue-50/30 transition-colors group">
                                        ...
                                        <td className="p-4">
                                            <div className="flex items-center text-green-600 text-[10px] font-black uppercase tracking-widest font-sans">
                                        ...
                                        <td className="p-4 text-right">
                                            <div className="flex justify-end space-x-2">
                                                ...
                                                <button className="p-2 text-slate-300 hover:text-emerald-600 hover:bg-emerald-50 rounded-lg transition border border-transparent hover:border-emerald-100">
                                                    <Download size={16}/>
                                                </button>
                                    ...
                                    <tr>
                                        <td colSpan="5" className="p-24 text-center">
                                            <div className="flex flex-col items-center">
                                                ...
                                                <p className="text-slate-400 text-sm font-bold uppercase tracking-widest">No entries found for this operator.</p>
                                            </div>
                                        </td>
                                    </tr>
                                )}
