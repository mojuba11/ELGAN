                    ...
                    <div className="overflow-x-auto">
                        <table className="w-full text-left border-collapse min-w-[1300px]">
                            ...
                            <tbody className="divide-y divide-slate-100">
                                {loading ? (
                                    <tr><td colSpan="8" className="p-20 text-center text-slate-400 animate-pulse font-bold uppercase text-xs tracking-widest">Syncing Fleet Data...</td></tr>
                                ) : entries.length > 0 ? entries.map((entry) => (
                                    <tr key={entry._id} className="hover:bg-cyan-50/20 transition-colors text-xs font-bold uppercase text-slate-700">
                                        <td className="p-4 text-[#0089A3] font-black">{entry.vesselName}</td>
                                        ...
                                        <td className="p-4 text-orange-600">{entry.dateOfInspection || 'Pending'}</td>
                                        <td className="p-4">{entry.terminal}</td>
                                        <td className="p-4">{entry.agentName || 'Not Assigned'}</td>
                                    ...
                                    <tr><td colSpan="8" className="p-20 text-center text-slate-400 font-bold uppercase text-xs tracking-widest">No entries found.</td></tr>
                                )}
                            </tbody>
                        </table>
                    </div>
                ...
                <div className="bg-slate-900 rounded-3xl shadow-xl overflow-hidden border border-slate-800">
                    ...
                    <div className="p-8 grid grid-cols-1 md:grid-cols-2 gap-8">
                        ...
                        <div className="md:text-right">
                            <p className="text-[10px] font-black text-[#0089A3] uppercase tracking-widest mb-2">2% Assessor Fee (Verified)</p>
                ...
                <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-slate-900/60 backdrop-blur-sm">
                    <div className="bg-white w-full max-w-2xl rounded-[2.5rem] overflow-hidden shadow-2xl animate-in fade-in zoom-in duration-200">
                        <div className="bg-[#0089A3] p-8 flex justify-between items-center text-white">
                            <div>
                                <h2 className="text-2xl font-black uppercase tracking-tighter leading-none">Vessel Manifest</h2>
                                <p className="text-[10px] font-bold opacity-80 uppercase tracking-widest mt-2">Internal Operations Record</p>
                            </div>
                        ...
                        <div className="p-10 grid grid-cols-2 gap-y-8 gap-x-12 text-sm uppercase border-b border-slate-50">
                            ...
                            <div><p className="text-[10px] text-slate-400 font-black mb-1 tracking-widest">Arrival Date</p><p className="font-bold text-slate-800">{selectedEntry.dateOfArrival}</p></div>
